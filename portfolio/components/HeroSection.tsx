...
/* ── centered container matching page-wrapper width ── */
const CW = 1060;
...
export function HeroSection() {
  ...
  /* shared centered wrapper style */
  const centered:React.CSSProperties = {
    maxWidth: CW, margin:"0 auto",
    ...
    <>
      <style>{`
        ...
        @media (min-width:541px) and (max-width:768px) {
          .hero-av,.hero-av-lit { width:100px !important; height:100px !important; font-size:20px !important; }
        }
        .av-wrap .hero-av     { transition:opacity 0.3s,box-shadow 0.3s; }
        .av-wrap .hero-av-lit { position:absolute;inset:0;border-radius:50%;opacity:0;transition:opacity 0.3s; }
        .av-wrap.lit .hero-av     { opacity:0; }
        .av-wrap.lit .hero-av-lit { opacity:1; }
      `}</style>
      ...
      <section id="about" style={{
        ...
        {/* ── PROFILE: full viewport width black bg ── */}
        <div style={{
        ...
        </div>{/* end full-width profile */}

        {/* ── GAP: dot bg shows through ── */}
        <div style={{height:20}}/>

        {/* ── INFO + SOCIAL — centered, same width ── */}
        <div style={centered}>
          <div style={{background:BG,border:B}}>
            ...
            <div style={{padding:"16px 18px 14px"}}>
              <div className="hero-grid" style={{
                display:"grid",gridTemplateColumns:"1fr 1fr",gap:"11px 48px",
              }}>
