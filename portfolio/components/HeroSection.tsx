    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          gap: 0, borderBottom: BORDER,
          background: BG,
        }}>
          {/* Avatar column — left, with right border */}
          <div style={{ borderRight: BORDER, padding: "20px 20px" }}>
            <div
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 24, fontWeight: 800, color: "#1c1917",
                  fontFamily: "'Geist Mono', monospace",
                }}
              >
                IT
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
            ...
            {/* Name row */}
            <div style={{
              borderTop: BORDER, padding: "8px 20px 0",
            }}>
              <h1 style={{
        ...
        <div style={{
          ...
          {LEFT_ITEMS.map((item, i) => {
            ...
            const cellStyle = {
              ...
              padding: "12px 16px",
              borderBottom: i < LEFT_ITEMS.length - 1 ? BORDER : "none",
              background: BG,
              color: "#a1a1aa",
              fontSize: 13,
            ...
            return (
              <div key={i} style={{ display: "contents" }}>
                ...
                {item.href ? (
                  <a
                    href={item.href}
                    target={item.href.startsWith("http") ? "_blank" : item.href.endsWith(".pdf") ? "_blank" : undefined}
                    rel="noreferrer"
                  ...
                  <div style={{ ...cellStyle, borderRight: BORDER, cursor: "default" }}>
                    {item.icon}
                    <span>{item.label}</span>
                  </div>
                )}
          ...
          {SOCIAL_TILES.map((s, i) => (
            <a
              ...
              style={{
                ...
                padding: "16px 16px",
                borderRight: i < SOCIAL_TILES.length - 1 ? BORDER : "none",
                background: BG,
                color: "#fafafa",
            ...
            >
              <div style={{
                ...
                background: s.bg,
                border: s.color ? "none" : "1px solid #27272a",
                display: "flex", alignItems: "center", justifyContent: "center",
              ...
              <span style={{ position: "absolute", top: 12, right: 12, color: "#52525b" }}>
                <ArrowUpRight />
              </span>
            </a>
          ))}
