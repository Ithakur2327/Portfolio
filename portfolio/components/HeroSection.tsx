    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        /* ══════════════════════════════════════
           ...
           Unified card, 70svh, full mobile feel
        ══════════════════════════════════════ */
        @media (min-width: 601px) and (max-width: 1024px) {

          /* Outer section — full 70svh, centred vertically */
          .h-tablet-outer {
          ...
          /* Inner card — full width, bordered, stacked */
          .h-tablet-card {
            display: flex !important;
            flex-direction: column !important;
            width: 100% !important;
          ...
          /* Profile strip — avatar left, name right */
          .h-profile {
          ...
          .h-avatar {
            ...
            min-width: clamp(100px, 22vw, 150px) !important;
            height: clamp(100px, 22vw, 150px) !important;
            min-height: clamp(100px, 22vw, 150px) !important;
          ...
          /* Info grid — single col like mobile */
          .h-grid {
          ...
          /* Info+social block — no extra margin */
          .h-info-wrap {
          ...
          /* Gap between profile and info */
          .h-tablet-gap { display: none !important; }
        }
      ...
      >
        ...
        {/* ════════════════════════════════
            TABLET LAYOUT — unified card
            Hidden on desktop & mobile via CSS
        ════════════════════════════════ */}
        <div className="h-tablet-outer" style={{
          position:"relative", left:"50%", marginLeft:"-50vw", width:"100vw",
          background:BG,
          /* Desktop/mobile: invisible wrapper, no effect */
        }}>
          <div className="h-tablet-card">
            ...
            {/* Info + Social — directly below profile, no gap */}
            <div className="h-info-wrap" style={{borderLeft:"none", borderRight:"none"}}>
              <HoverBorderGradient>
                <div style={{background:BG, border:"none"}}>
        ...
        {/* ════════════════════════════════
            ...
            (original structure, tablet classes have no effect here)
        ════════════════════════════════ */}

        {/* ── PROFILE ROW ── */}
        <div className="h-desktop-profile" style={{
          position:"relative", left:"50%", marginLeft:"-50vw", width:"100vw",
        ...
        <div className="h-desktop-gap" style={{height:38, maxWidth:CW, margin:"0 auto"}}/>

        {/* ── INFO + SOCIAL ── */}
        <div className="h-desktop-info h-info-wrap" style={{borderLeft:B, borderRight:B}}>
          <HoverBorderGradient>
