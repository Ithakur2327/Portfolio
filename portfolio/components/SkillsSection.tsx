...
/* ─── Tech definitions
   dark-mode icons: white/gray SVGs get a brightness boost via `bright: true`
   so they don't look dull on dark backgrounds.
──────────────────────────────────────────────────────────────── */
const TECH: Record<string, { color: string; logo: string; bright?: boolean }> = {
  // Languages
  ...
  // Backend — REST APIs gets a proper OpenAPI/swagger icon, not Postman
  "Node.js":      { color: "#339933", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg" },
  "Express.js":   { color: "#e2e8f0", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg", bright: true },
  ...
  // GenAI / AI
  "LLM APIs":     { color: "#74aa9c", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/openai/openai-original.svg", bright: true },
  ...
  // Cloud & DevOps (comes FIRST in row 2)
  ...
  Vercel:         { color: "#e2e8f0", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vercel/vercel-original.svg", bright: true },
  // Tools & Database
  ...
  GitHub:         { color: "#e2e8f0", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg", bright: true },
...
/* ─── SkillChip ───
   • 3 chips per row always (grid, not flexwrap)
   • bright icons get extra brightness in dark mode
─────────────────── */
const SkillChip = memo(function SkillChip({
  ...
  // bright flag: boost white/gray icons so they're vivid on dark bg
  const brightFilter = tech.bright
    ? "brightness(1.9) contrast(1.1)"
    : "none";

  const imgStyle: React.CSSProperties = {
    objectFit: "contain", userSelect: "none", pointerEvents: "none",
    filter: visible ? brightFilter : "grayscale(1) opacity(.3)",
  ...
  return (
    ...
    >
      <div style={{
        ...
        boxShadow: visible ? `0 0 10px ${glowColor},0 0 24px ${glowColor}66` : "0 0 0px transparent",
        opacity: visible ? 1 : 0,
...
/* ─── LampSkillBox ───
   Chips are laid out in a CSS grid: always 3 columns, auto rows.
   This ensures uniform 3-per-row alignment regardless of count.
──────────────────── */
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Chips — CSS grid, 3 columns always */}
        <div style={{
          padding: "0 14px 18px",
          display: "grid",
              ...
              <div style={{
                ...
                {tech.logo && (
                  <img
                    ...
                    style={{
                      objectFit: "contain",
                      filter: tech.bright ? "brightness(1.9) contrast(1.1)" : "none",
                    }}
                    onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }}
                  />
                )}
    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        @media (max-width: 900px) {
          ...
          /* 3rd card in each row wraps to span full width on its own row */
